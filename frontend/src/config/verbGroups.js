...
export const VERB_GROUP_CHOICES = [
  { key: 'group1', label: '1<sup>er</sup> groupe<br>(-ER, réguliers)' },
  { key: 'group2', label: '2<sup>ème</sup> groupe<br>(##ISS##)' },
  { key: 'group3', label: '3<sup>ème</sup> groupe<br>(<em>melting pot</em> 🙃)' }
];
